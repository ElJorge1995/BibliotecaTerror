...
1. **Servidor Base de Datos XAMPP**: Enciende Apache y MySQL desde el Control Panel. En phpMyAdmin importa los SQL de la carpeta `database/` en orden: `01_apiloging_schema.sql`, `02_libros_schema.sql`, `03_libros_seed.sql`.
