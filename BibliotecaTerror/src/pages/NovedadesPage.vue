...
const fetchNovedades = async () => {
  ...
  error.value = null
  try {
    const res = await booksApi.getRecientes(32, authStore.user?.id || null)
...
<template>
  <div class="novedades-page page-container">
    <header class="page-header">
      <h1>Novedades de la Biblioteca</h1>
      <p class="search-term">Descubre las últimas 32 obras malditas que acaban de llegar a nuestras estanterías.</p>
    </header>
    ...
    <div class="results-container">
      ...
      <div v-else-if="books.length === 0" class="no-results">
        ...
        <p>Aún no hay nuevos libros en esta categoría.</p>
      </div>
